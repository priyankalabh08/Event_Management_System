...
<body class="skin-black">
	...
	<header class="header">
		<a href="index.html"> <!-- Add the class icon to your logo image or logo icon to add the margining -->
		<img src='<c:url value="/resources/images/gspl.png"/>'  class="logo"
			...
			<div class="navbar-right">
				<ul class="nav navbar-nav">
								...
								<ul class="menu">
									<li>
										<!-- start message --> <a href="#">
											<div class="pull-left">
												<img src='<c:url value="/resources/images/admin.png"/>' class="img-circle"
													alt="User Image" />
											</div>
											<h4>
					...
					<li class="dropdown user user-menu"><a href="#"
						...
						<ul class="dropdown-menu">
							<!-- User image -->
							<li class="user-header bg-light-black"><img
								src='<c:url value="/resources/images/admin.png"/>' class="img-circle" alt="User Image" />
								<p>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src='<c:url value="/resources/images/admin.png"/>' class="img-circle" alt="User Image" />
					</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-bar-chart-o"></i> <span>Tutorial</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
						<c:url  value="admin/camerabasic" var="camerabasic"/>
							<li><a href="${camerabasic}"><i
									class="fa fa-angle-double-right"></i>Camera Basic</a></li>
					...
					<li><a href="pages/mailbox.html"> <i
  ...
  <script src='<c:url value="/resources/js/ckeditor/ckeditor.js" />'  type="text/javascript"></script>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                CKEDITOR.replace('camerabasic');
                CKEDITOR.replace('camerabasic1');
            });
        </script>
